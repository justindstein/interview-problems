...
public class SquaresOfASortedArrayTest {
  ...
  private static SquaresOfASortedArray squaresOfASortedArray;
  ...
  public void example2() {
    int[] result = squaresOfASortedArray.sortedSquares(new int[] {-7, -3, 2, 3, 11});
    Assert.assertArrayEquals(new int[] {4, 9, 9, 49, 121}, result);
  }
