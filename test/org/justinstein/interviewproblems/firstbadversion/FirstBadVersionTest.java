...
public class FirstBadVersionTest {
   ...
   * Example 1:
   * 
   * Input: n = 5, bad = 4 Output: 4 Explanation: call isBadVersion(3) -> false call isBadVersion(5)
   * -> true call isBadVersion(4) -> true Then 4 is the first bad version. Example 2:
   * 
